...
class SqlGet():
    ...
    def run(self):
            ...
            if os.path.isfile(file):
                ...
                try: 
                    ...
                    try:
                        ...
                        self.log.info('Records Returned: ' + str(len(df)))

                        # Try to save df to file.
                        try: 
                            self.log.info('Saving Data: ' + destination)
                            ...
                            self.log.info('File Complete: ' + str(round(time.time() - file_start_time,3)))
        ...
        self.log.info('Get Process Complete: ' + str(round(time.time() - start_time,3)))
        return True